  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.section}>
        ...
        {[
          { label: "Notificaciones push", subtitle: "Ofertas y estado de pedidos", value: notifications, setter: setNotifications },
          { label: "Modo oscuro", subtitle: "Cambiar apariencia de la app", value: darkMode, setter: setDarkMode },
          { label: "Acceso biométrico", subtitle: "Huella o Face ID", value: biometrics, setter: setBiometrics },
          { label: "Newsletter", subtitle: "Novedades y promociones", value: newsletter, setter: setNewsletter },
        ].map((item) => (
      ...
      <View style={styles.section}>
        ...
        <View style={styles.deepLinkCard}>
          ...
          <Text style={styles.deepLinkNote}>
            💡 Prueba con: expo start --android y adb shell am start -W -a android.intent.action.VIEW -d "myapp://product/1"
          </Text>
        </View>
      </View>
